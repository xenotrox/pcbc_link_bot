...
class Connection(object):
    ...
    def shorten_processed(self, uri, x_login=None, x_apiKey=None,
        ...
        shortendURL = str(data['data'])
        shortendURL = shortendURL.split("'")
        return shortendURL[3]
    ...
    def user_link_edit_processed(self, link, title, note):
        self.user_link_edit(link, title=title, edit='title')
        self.user_link_edit(link, note=note, edit='note')
